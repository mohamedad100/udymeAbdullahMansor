...
class CacheHelper{
  ...
  static init()async{
    ...
    sharedPreferences =await SharedPreferences.getInstance();    //  طريقه تعريفها/و استدعيتها في ال main
  }
...
})async
{
  ...
  })async
  {
    ...
    if(value is String) return await  sharedPreferences?.setString(key, value as String) ;
